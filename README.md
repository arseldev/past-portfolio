...
<div align="center">
  <a href="#">
    <img src="images/myskill/react (2).png" alt="Logo" width="80" height="80">
  </a>

  <h3 align="center">Past Portfolio</h3>

  <p align="center">
    Website porfolio saya sebelumnya.
    <br />
    <a href="https://accenggg-portfolio.vercel.app/"><strong>Explore the Website »</strong></a>
    <br />
    <br />
...
1. Clone repository
   ```sh
   git clone https://github.com/arseldev/past-portfolio
   ```
2. Jalankan program
   ```sh
